...
#ifndef VALUETINYINT_H
#define VALUETINYINT_H

#include "table/ValueIncrementable.h"

class ValueTinyint : public ValueIncrementable
{

public:
    ValueTinyint();
    ValueTinyint(int8_t value);
    virtual ~ValueTinyint();
